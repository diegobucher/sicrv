	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "Exibir _MENU_ atividades",
				"sZeroRecords": "Nenhum registro correspondente encontrado",
				"sEmptyTable": "Não há dados disponíves na tabela",
				"sInfo": "Exibindo _START_ até _END_ de _TOTAL_ atividades",
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+sSpace+'<input style="width:220px;" type="text" />';
